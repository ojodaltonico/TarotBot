...
class FakeAIProvider(AIProvider):
    ...
    def generate(self, messages: list[AIMessage], *, purpose: str, options=None) -> AIResponse:
        ...
        if self.mode == "demo":
            ...
            direct_video="podemos hacer videollamada" in text or "podemos hacer una videollamada" in text
            if "otros temas" in text and "salud" in text: value={"reply":"También podemos mirar familia, viajes, amistades, decisiones personales o proyectos. ¿Qué te interesa más?","intent":"general_chat","next_state":"CHATTING","reading_recommended":False,"suggested_spread":None,"action":"none","memory_candidates":[]}
            elif "viaje" in text: value={"reply":"Podemos hacer una tirada general para mirar ese tema.","intent":"general_reading","next_state":"READY_FOR_READING","reading_recommended":True,"suggested_spread":"general_three","memory_candidates":[]}
            elif direct_video: value={"reply":"No puedo hacer videollamadas, pero podemos seguir por acá.","intent":"general_chat","next_state":"CHATTING","reading_recommended":False,"suggested_spread":None,"action":"none","memory_candidates":[]}
            elif "videollamada" in text: value={"reply":"¿Te referís a una videollamada entre ustedes o querés preguntarme si podemos hacer una por acá?","intent":"unclear","next_state":"CHATTING","reading_recommended":False,"suggested_spread":None,"action":"none","memory_candidates":[]}
            elif "no puedo salir adelante" in text: value={"reply":"¿Qué es lo que más te está pesando ahora?","intent":"general_chat","next_state":"CHATTING","reading_recommended":False,"suggested_spread":None,"action":"none","memory_candidates":[]}
            elif "nombre" in text and any(word in text for word in ("necesito", "necesitás", "hace falta", "dato")): value={"reply":"No hace falta. Si querés dar un poco de contexto ayuda a enfocarla, pero no es requisito.","intent":"general_chat","next_state":"CHATTING","reading_recommended":False,"suggested_spread":None,"action":"none","memory_candidates":[]}
            elif lottery: value={"reply":"No puedo decirte un número ganador. Si querés, podemos hablar de qué te preocupa de esa apuesta.","intent":"general_chat","next_state":"CHATTING","reading_recommended":False,"suggested_spread":None,"action":"none","memory_candidates":[]}
