...
class FakeAIProvider(AIProvider):
    ...
    def generate(self, messages: list[AIMessage], *, purpose: str, options=None) -> AIResponse:
        ...
        if self.mode == "demo":
            ...
            if direct_video: value={"reply":"No puedo hacer videollamadas, pero podemos seguir por acá.","intent":"general_chat","next_state":"CHATTING","reading_recommended":False,"suggested_spread":None,"action":"none","memory_candidates":[]}
