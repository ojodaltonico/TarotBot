...
class LabChatRequest(BaseModel): user_key:str=Field(min_length=1,max_length=64,pattern=r"^[A-Za-z0-9_-]+$");message:str=Field(min_length=1,max_length=2000)
...
class LabChatResponse(BaseModel): reply:str;state:str;intent:str;reading_recommended:bool;suggested_spread:str|None;usage:UsageResponse|None
...
class LabReadingResponse(BaseModel): reading_id:int;spread:str;cards:list[dict];interpretation:str|None;summary:str|None;state:str
